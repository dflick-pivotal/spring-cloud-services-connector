 ...
 * @author Roy Clarkson
 */
public class UpsiHystrixAmqpServiceInfoCreator extends CloudFoundryServiceInfoCreator<HystrixAmqpServiceInfo> {
	...
	public UpsiHystrixAmqpServiceInfoCreator() {
		super(new Tags(TAG_NAME));
	}

	@Override
	public boolean accept(Map<String, Object> serviceData) {
		return ((String) serviceData.get("name")).startsWith("circuit-breaker");
	}
