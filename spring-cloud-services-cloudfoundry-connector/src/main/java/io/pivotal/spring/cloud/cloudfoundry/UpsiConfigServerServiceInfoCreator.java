 ...
 * @author Will Tran
 */
public class UpsiConfigServerServiceInfoCreator extends CloudFoundryServiceInfoCreator<ConfigServerServiceInfo> {
	...
	public UpsiConfigServerServiceInfoCreator() {
	...
	public boolean accept(Map<String, Object> serviceData) {
		return ((String) serviceData.get("name")).startsWith("config-server");	}
}
