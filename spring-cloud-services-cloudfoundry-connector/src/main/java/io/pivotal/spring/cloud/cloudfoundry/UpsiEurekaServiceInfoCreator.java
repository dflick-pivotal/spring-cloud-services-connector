 ...
 */
public class UpsiEurekaServiceInfoCreator extends CloudFoundryServiceInfoCreator<EurekaServiceInfo> {
	private static final String CREDENTIALS_ID_KEY = "name";
	private static final String EUREKA_SERVICE_TAG_NAME = "eureka";

	public UpsiEurekaServiceInfoCreator() {
	...
	public boolean accept(Map<String, Object> serviceData) {
		return ((String) serviceData.get("name")).startsWith("service-registry");
	}
}
